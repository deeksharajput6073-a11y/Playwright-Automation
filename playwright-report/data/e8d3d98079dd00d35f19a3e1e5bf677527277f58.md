...
- Location: tests\Checkout\payment.spec.js:16:1
              ...
              - generic:
                - generic:
                  - generic:
                    - button "Pause video":
                      - img
              - button "Unmute video" [ref=f78e15] [cursor=pointer]
            - button "Replay" [ref=f78e23]:
              - img [ref=f78e25] [cursor=pointer]
            - img [ref=f78e30]
          - button "Learn more" [ref=f78e37] [cursor=pointer]
```