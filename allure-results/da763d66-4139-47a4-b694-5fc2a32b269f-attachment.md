...
- Name: cart\recommendedItems.spec.js >> Verify Recommended Items
- Location: tests\cart\recommendedItems.spec.js:5:1
...
Call log:
  - attempting scroll into view action
    ...
    - retrying scroll into view action
      - waiting 100ms
    8 × waiting for element to be stable
      - element is not visible
    - retrying scroll into view action
      - waiting 500ms
          ...
          - iframe [ref=f7e1]:
            - generic [ref=f8e2]:
              ...
              - link [ref=f8e4] [cursor=pointer]:
                - /url: https://insight.adsrvr.org/track/clk?imp=b4ed0956-7a27-4d12-9e58-d5226a2c24cd&ag=ra1cyrj&sfe=1c68b84b&sig=fPJyMiW8L_8J3Gy7am62R3XLzIm0Lqkrzuv8bGH93BM.&crid=sl6fvezp&cf=10748567&fq=0&t=1&td_s=automationexercise.com&rcats=&mste=&mfld=3&mssi=&mfsi=&sv=google&uhow=65&agsa=&wp=ajE4SwAEHdoB7oZsADbMjIb7Y8HrmeA4UJJiVA&rgz=474005&dt=PC&osf=Windows&os=Windows11&br=Chrome&svpid=pub-1677597403311019&rlangs=en&mlang=&did=&rcxt=Other&tmpc=40.97000000000003&vrtd=&osi=&osv=&daid=&dnr=0&vpb=&crrelr=&npt=&cc=3~KLUv_WPYfRZoAALtDAAUEVYJ7bQnehJNEZ5Y1SJqLCTNQgdyYTFjeXJqSLbo2w1Ql4WQBVoIc2w2ZnZlenBgzdn-b25BRzFLRm9HeXpZbktzemFnMGFTYXN3QdIBNBggLSBHd2FsaW9yaDc0MZvyjr2_27MBGCB6bnl6dmQz0AKjn4wDilNAfEQOYjFhfGRhbXwtQ1JNNC3E7cDF6-mlPwoxMJjNk5G5wWJoTG0tVXdXXzBnVFZqNGZiMXlndh870k9ZrKQHXZclSPwEg4iuOiM8s0ARjgH3Y9hxTHyXheG778suAAYItoYThhP4A5gTAKgTPMgTPNATAP0TexSOP4AUAaAUALAUALgUAMgUAOoUCwib8o69v9uzARgg8BSRASr8KzgGl1glSg7v1fWe-qBOFRsySlsP3ukyI96f7O8pEVqg_QW_0YCkUch6lTbCFYVNjHex-FKaOIdsgnPk-hGULa1wHh4Ly9kXdHpr9CHw2tsbY02D6sZFxga7NElVCawhahHCRVU__xe6CqobZ1aOzmdQ1vw01Yqpc2E1mZWpySqW88ciy0vDAg..&dur=1~KLUv_SMFoCgkXbUAAEggAigFTWEtQz4DfACfji89wd3jDnw.&durs=i8KB5y&bdc=13&testid=b1a%7Cdam%7C-CRM4-&fpa=371&pcm=3&ict=Unknown&said=bhLm-UwW_0gTVj4fb1ygvw&auct=1&tail=1&r=https://adclick.g.doubleclick.net/aclk%3Fsa%3DL%26ai%3DCVJ1jSzgxatq7EOyMur8PjJnbmQ6-p-f2dPb-j45XwI23ARABIP20npUBYOWi54PEDsgBCagDAcgDAqoE7QFP0FG18_xXAEMs5hCaf_5dAxmQeTLmLUxjER4p6V0-xMGu402jaUbql_3Wu53k-Cj4AiaEfDVNH3tQwLPHxvsUssm86omPcKH2scdlmapTFfFCxCp2h9-4yUGW8E9YbAUV3WZR4Q4nAd5Xs4J8dZhOLwjoE9KElsrmXg6LiLUduAj7aZGlBAucW__MnjPucXE0mwfY87yJahLMnogA2fWCqLzGxgFjdwNz9VpK25mJnoMNTittYhPKg-WkKckVFzBbSODvW8z_FzdWNdGqPXmZCcutYjwKKmaTylHoehMqG-9pCAmj6Mo5nW2OOUmABuDF-p7S6MO_8AGgBiGoB5PYsQKoB5TYsQKoB5XYsQKoB6a-G6gHltgbqAeqm7ECqAf_nrECqAffn7ECqAetvrECqAe_07EC2AcA0ggwCIBhEAEyCIqCgICAgIAIOg-AQIDAgICAgKiAAqiDgBBIvf3BOljFxeTJ2IuVA2AA-gsCCAGADAGqDQJJTuoNEwjVkOrJ2IuVAxVshu4BHYzMNuOIDgnQFQGAFwGyFwQYDFAB%26num%3D1%26sig%3DAOD64_1E8_szyHlsLE1xdx6VUqpfyqIuOg%26client%3Dca-pub-1677597403311019%26adurl%3Dhttps://netshort.onelink.me/XC68?pid=thetradedesk_int&af_siteid=automationexercise.com&c=znyzvd3&af_c_id=znyzvd3&af_adset_id=ra1cyrj&af_ad_id=sl6fvezp&af_click_lookback=7d&clickid=b4ed0956-7a27-4d12-9e58-d5226a2c24cd&idfa=&advertising_id=&android_id=
                - img [ref=f8e5]
      - generic [ref=e90]:
...
```ts
  ...
  7   | 
  8   |         // Product Details
  9   |         this.firstViewProduct = page.locator("a[href*='/product_details/']").first();
  10  |         this.productInfo = page.locator('.product-information');
  11  |         // Add To Cart
  12  |         this.firstAddToCartBtn = page.locator('.features_items .productinfo .add-to-cart').first();
  13  |         // View Cart Popup Button
  14  |         this.viewCartBtn = page.getByRole('link', { name: 'View Cart' });
  15  |         // Search Product
  16  |         this.searchInput = page.locator('#search_product');
  17  |         this.searchButton = page.locator('#submit_search');
  18  |         this.searchedProductsText = page.locator('h2.title.text-center');
  19  |         // Category Filter
  20  |         this.womenCategory = page.locator("a[href='#Women']");
  21  |         this.womenDressCategory = page.locator("a[href='/category_products/1']");
  22  |         this.categoryTitle = page.locator('.title.text-center');
  23  |         // Quantity Update
  24  |         this.quantityInput = page.locator('#quantity');
  25  |         this.addToCartDetailBtn = page.locator('button.cart');
  26  |         // Recommended Items
  27  |         this.recommendedSection = page.locator('.recommended_items');
  28  |         this.recommendedAddToCart = page.locator('.recommended_items .productinfo .add-to-cart').first();
  29  |         // Remove Cart
  30  |         this.deleteProductButton = page.locator('.cart_quantity_delete');
  31  |         this.emptyCartText = page.getByText('Cart is empty');
  32  |     }
  33  | 
  34  |     // View Product Details
  35  |     async viewFirstProduct() {
  36  | 
  37  |         await Promise.all([
  38  |             this.page.waitForURL(/product_details/),
  39  |             this.firstViewProduct.click()
  40  |         ]);
  41  |     }
  42  | 
  43  |     // Add Product To Cart
  44  |     async addFirstProductToCart() {
  45  | 
  46  |         await this.firstAddToCartBtn.scrollIntoViewIfNeeded();
  47  | 
  48  |         await this.firstAddToCartBtn.click();
  49  | 
  50  |         await this.page.waitForTimeout(2000);
  51  |     }
  52  | 
  53  |     // Click View Cart
  54  |     async clickViewCart() {
  55  | 
  56  |         await this.viewCartBtn.click();
  57  |     }
  58  | 
  59  |     // Search Product
  60  |     async searchProduct(productName) {
  61  | 
  62  |         await this.searchInput.fill(productName);
  63  | 
  64  |         await this.searchButton.click();
  65  |     }
  66  | 
  67  |     // Category Filter
  68  |     async selectWomenCategory() {
  69  | 
  70  |         await this.womenCategory.click();
  71  | 
  72  |         await this.womenDressCategory.click();
  73  |     }
  74  | 
  75  |     // Update Quantity
  76  |     async updateQuantity(quantity) {
  77  | 
  78  |         await this.quantityInput.clear();
  79  | 
  80  |         await this.quantityInput.fill(quantity);
  81  |     }
  82  | 
  83  |     // Add Product Detail To Cart
  84  |     async addProductDetailToCart() {
  85  | 
  86  |         await this.addToCartDetailBtn.click();
  87  | 
  88  |         await this.page.waitForTimeout(2000);
  89  |     }
  90  | 
  91  |     // Scroll To Recommended Items
  92  |     async scrollToRecommended() {
  93  | 
  94  |         await this.recommendedSection.scrollIntoViewIfNeeded();
  95  |     }
  96  | 
  97  |     // Add Recommended Item
  98  |     async addRecommendedItem() {
  99  | 
> 100 |         await this.recommendedAddToCart.scrollIntoViewIfNeeded();
      |                                         ^ Error: locator.scrollIntoViewIfNeeded: Test timeout of 30000ms exceeded.
  101 | 
  102 |         await this.recommendedAddToCart.click();
  103 |     }
  104 | 
  105 |     // Remove Product
  106 |     async removeProduct() {
  107 | 
  108 |         await this.deleteProductButton.click();
  109 |     }
  110 | }
  111 | 
  112 | module.exports = ProductPage;
```