...
- Name: Products\removeCart.spec.js >> Remove Product From Cart
- Location: tests\Products\removeCart.spec.js:4:1
...
- generic [active] [ref=e1]:
  ...
  - contentinfo [ref=e744]:
    - generic [ref=e749]:
      - heading "Subscription" [level=2] [ref=e750]
      - generic [ref=e751]:
        - textbox "Your email address" [ref=e752]
        - button "" [ref=e753] [cursor=pointer]:
          - generic [ref=e754]: 
        - paragraph [ref=e755]:
          - text: Get the most recent updates from
          - text: our site and be updated your self...
    - paragraph [ref=e759]: Copyright © 2021 All rights reserved
  - text: 
```
...
> 10 |         await page.goto('/products');
     |                    ^ Error: page.goto: Test timeout of 30000ms exceeded.
  11 | 
  12 |         // Add product first
  13 |         await product.addFirstProductToCart();
  14 | 
  15 |         await product.clickViewCart();
  16 | 
  17 |         // Remove product
  18 |         await product.removeProduct();
  19 | 
  20 |         await expect(product.emptyCartText).toBeVisible();
  21 |     }
  22 | );
```